...
with st.expander("📖 このアプリについて", expanded=False):
    ...
    **今後の修正予定**
    - 解答の文章が一部だけしか表示されていないので、変更をします
    - 昨年出題した問題があるので、データを新しくします
    - データが一部入っていないため、その部分を確認後、入力します

    **お願い**
    中小企業診断士の仲田俊一がプライベートで作ったアプリです。
    XやInstagramをフォローしていただいたり、このアプリをシェアしていただけると、泣いて喜びます！！
    """)
